...
class DepartmentController extends Controller
{
    ...
    public function departments(Request $request)
    {
        ...
        },'DoctorClinic.clinic:id,name,address,latitude,longitude'])->where([['region_id',$request->region_id],['department_id',$request->department_id]])->groupBy('doctor_id')->paginate(10);
