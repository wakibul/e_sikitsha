...
Route::group(['prefix' => 'doctor'], function () {
	...
	Route::get('/remove-cron/{id}', [
		'as' => 'doctor.cron.remove',
		'middleware' => ['admin'],
		'uses' => 'Admin\DoctorController@removeCron'
	]);

	Route::get('/add-cron/{id}', [
		'as' => 'doctor.cron.add',
		'middleware' => ['admin'],
		'uses' => 'Admin\DoctorController@addCron'
	]);
});
...
Route::group(['prefix' => 'report'], function () {
	...
	Route::get('/booking/delete/{id}', [
        'as' => 'booking.delete',
        'middleware' => ['admin'],
        'uses' => 'Admin\ReportController@destroy'
    ]);
...
Route::post('/change-password/store', [
    'as' => 'change_password.store',
    'middleware' => ['admin'],
    'uses' => 'Admin\AdminController@changePasswordStore'
]);
