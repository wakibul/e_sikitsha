            ...
            <div class="card-body">
                    <div class="row">
                          <div class="col-md-12 col-lg-12">
                            ...
                            <form name="city" action="{{route('admin.doctor.update',Crypt::encrypt($doctor->id))}}" method="POST" id="SignupForm" enctype="multipart/form-data">
                            @csrf
                          <fieldset>
                          ...
                          <div class="form-group">
    			                              <div class="row">
    			                                    ...
    			                                    <div class="col-md-6">
    			                                      <input type="radio" name="special_doctor" id="special_doctor" class="validate[required]" value="1" @if($doctor->special_doctor == 1) checked @endif> Yes

    			                                      <input type="radio" name="special_doctor" id="special_doctor" class="validate[required]" value="0" @if($doctor->special_doctor == 0) checked @endif> NO
    			                                    </div>
    			                               </div>
                                </div>
