...
@section('content')
 <div class="container card">
    <div class="row">
        <div class="col-12">
            <div class="page-header">
              <h1 class="page-title">
                ...
                Add More schedule for {{$doctor->name}}
              </h1>
            </div>
            <div class="card-body">
                    <div class="row">
        ...
        <form name="city" action="{{route('admin.doctor.post_add_more_schedule',Crypt::encrypt($doctor->id))}}" method="POST" id="SignupForm" enctype="multipart/form-data">
                            @csrf
                          <fieldset>
