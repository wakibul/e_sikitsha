                    ...
                    <div class="row">
                          ...
                          <fieldset>
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <input type="text" name="name" class="form-control validate[required]" value="{{$doctor->name}}">
                                  </div>
                             </div>
                             </div>
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <input type="number" name="phone_no" class="form-control" value="{{$doctor->phone_no}}">
                                  </div>
                             </div>
                           </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                             <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <input type="text" name="current_city"  class="form-control validate[required]" value="{{$doctor->current_city}}">
                                  </div>
                             </div>
                           </div>
                          ...
                          <fieldset>
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <input type="text" name="qualification" class="form-control validate[required]" value="{{$doctor->qualification}}">
                                  </div>
                             </div>
                             </div>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-3">
                                      <select name="year" class="form-control validate[required]">
                                        ...
                                        @for($i=0;$i<=10;$i++)
                                        <option value="{{$i}}" @if($doctor->year == $i) selected @endif>{{$i}} Year</option>
                                        @endfor
                                    ...
                                    <div class="col-md-3">
                                      <select name="month" class="form-control validate[required]">
                                        <option value="">Select</option>
                                        @for($i=0;$i<=11;$i++)
                                        <option value="{{$i}}" @if($doctor->month == $i) selected @endif>{{$i}} Months</option>
                                        @endfor
                                      </select>
                                    </div>
                               </div>
                          ...
                          <div class="form-group">
                              <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <input type="text" name="licence_no" id="licence_no" class="form-control" value="{{$doctor->licence_no}}">
                                    </div>
                               </div>
                          <div>
                          ...
                          <div class="form-group">
                              <div class="row">
                                    <div class="col-md-2">Doctor Fees</div>
                                    <div class="col-md-6">
                                      <input type="number" name="doctor_fees" class="form-control validate[required]" value="{{$doctor->doctor_fees}}">
                                    </div>
                               </div>
                          </div>
                          ...
                          <div class="form-group">
                              <div class="row">
                                    <div class="col-md-2">Booking Charge</div>
                                    <div class="col-md-6">
                                      <input type="number" name="booking_charge" class="form-control validate[required]" value="{{$doctor->booking_charge}}">
                                    </div>
                               </div>
                          </div>
                          ...
                          <div class="form-group">
                              <div class="row">
                                    <div class="col-md-2">Agent Charge</div>
                                    <div class="col-md-6">
                                      <input type="number" name="agent_charge" class="form-control validate[required]" value="{{$doctor->agent_charge}}">
                                    </div>
                               </div>
                          </div>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <select name="fees_online"  class="form-control validate[required]">
                                        <option value="">Select</option>
                                        <option value="0" @if($doctor->fees_online) == 0) selected @endif>Offline</option>
                                        <option value="1" @if($doctor->fees_online) == 1) selected @endif>Online</option>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <select name="dr_available_days" class="form-control" required>
                                      	...
                                      	@for($i=1;$i<30;$i++)
                                      	<option value="{{$i}}"  @if($doctor->dr_available_days == $i) selected @endif>{{$i}}</option>
                                      	@endfor
	                                     </select>
                                    </div>
                               </div>
                                    ...
                                    <div class="col-md-10">
                                    	<div class="row">
                                            <div class="col-md-12 week_days">
                                                ...
                                                @foreach($doctor->schedule as $key=>$val)
                                                @if($val->days == "Sunday")
                                                checked
                                                @endif
                                                @endforeach
                                                ...
                                                <div class="row child">
                                                  <div class="col-md-2">
                                                  <select name="schedule[Sunday][starttime][]"  class="form-control" required="true">
                                                ...
                                                <div class="col-md-2">
                                                <select name="schedule[Sunday][endtime][]"  class="form-control" required="true">
                                                  <option value="">Start Time</option>
                                                  <option value="12:00">12:00 PM</option>
                                                  <option value="12:30">12:30 PM</option>
                                                  <option value="13:00">01:00 PM</option>
                                                ...
                                                <div class="col-md-2">
                                                <select name="schedule[Sunday][region_id][]" class="form-control" onchange="getClinic(this)"  required="true"><option value="">Location</option> @foreach($cities as $city)<option value="{{$city->id}}">{{$city->name}}</option>@endforeach</select>
                                                </div>
                                                <div class="col-md-2">
                                                <select name="schedule[Sunday][clinic_id][]" class="form-control clinic"  required="true"><option value="">Clinic</option></select> 
                                                </div>
                                                @endif
                                                @endforeach
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 week_days">
                                                <input type="checkbox" name="days[]" id="day" class="validate[required]" value="Monday"
                                                    onclick="getSubItem(this)"  @foreach($doctor->schedule as $key=>$val)
                                                @if($val->days == "Monday")
                                                checked
                                                @endif
                                                @endforeach>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 week_days">
                                                <input type="checkbox" name="days[]"  id="day" class="validate[required]" value="Tuesday" onclick="getSubItem(this)" @foreach($doctor->schedule as $key=>$val)
                                                @if($val->days == "Tuesday")
                                                checked
                                                @endif
                                                @endforeach>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 week_days">
                                                <input type="checkbox" name="days[]" id="day" class="validate[required]" value="Wednesday"  onclick="getSubItem(this)" @foreach($doctor->schedule as $key=>$val)
                                                @if($val->days == "Wednessday")
                                                checked
                                                @endif
                                                @endforeach>
                                                Wednessday
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 week_days">
                                                <input type="checkbox" name="days[]" id="day" class="validate[required]" value="Thursday"  onclick="getSubItem(this)" @foreach($doctor->schedule as $key=>$val) @if($val->days == "Thursday")
                                                checked
                                                @endif
                                                @endforeach>
                                                Thursday
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 week_days">
                                                <input type="checkbox" name="days[]" id="day" class="validate[required]" value="Friday" onclick="getSubItem(this)" @foreach($doctor->schedule as $key=>$val) @if($val->days == "Friday")
                                                checked
                                                @endif
                                                @endforeach>
                                                Friday
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 week_days">
                                                <input type="checkbox" name="days[]" id="day" class="validate[required]" value="Saturday" onclick="getSubItem(this)"  @foreach($doctor->schedule as $key=>$val) @if($val->days == "Saturday")
                                                checked
                                                @endif
                                                @endforeach>
                                                Saturday
    ...
    <script>
      x=0;
        ...
        function get_row_data(checkbox_value){
            ...
            data += '<option value="">Book Before Days</option>';
            ...
            data += '<option value="">Book Before Time</option>';
            data += '<option value="12:00">12:00 PM</option>';
            data += '<option value="13:00">01:00 PM</option>';
            data += '<option value="14:00">02:00 PM</option>';
            data += '<option value="15:00">03:00 PM</option>';
