      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <a href="{{route('admin.doctor.index')}}" class="btn btn-danger">Clear Search</a>
            </div>
          </div>
          </form>
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @if($doctor->cron == 1)
                  <a href="{{route('admin.doctor.cron.remove',Crypt::encrypt($doctor->id))}}" class="btn btn-warning btn-sm"><i class="fa fa-minus"></i> Remove Cron</a>
                  @else
                  <a href="{{route('admin.doctor.cron.add',Crypt::encrypt($doctor->id))}}" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Add Cron</a>
                  @endif
