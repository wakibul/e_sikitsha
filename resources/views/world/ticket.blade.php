            ...
            <div class="card" id="ticket">
                    <div class="card-content">
                      <div class="card-header-blue">
                        ...
                        @if($booking->user_type == "franchise")        
                         <div class="row">
                              <div class="col-md-4 ">
                                <p>Agent Service Charge</p>
                              </div>
                              <div class="col-md-4 ">
                               <p> <strong>Rs. {{$booking->agent_charge}}</strong> </p>
                              </div>
                              <div class="col-md-4 ">
                              </div>
                         </div>  
                         @endif
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-4 ">
                                 <p> <strong>Rs. 
                                   @if($booking->fees_mode == 1)
                                  {{intval($booking->service_charge)+intval($booking->consultation_fees)+intval($booking->agent_charge)}} 
                                  @else
                                  {{intval($booking->service_charge+intval($booking->agent_charge))}} 
                                  @endif
                                </strong> </p>
